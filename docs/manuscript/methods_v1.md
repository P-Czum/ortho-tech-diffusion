...
Three phrases were removed as retronyms — names given to an existing standard only when a rival appeared (*mechanical alignment* after kinematic alignment; *single bundle* after double-bundle reconstruction; *anatomic total shoulder arthroplasty* after reverse shoulder arthroplasty) — and seven as generic descriptions of established procedures. The detector sees such naming events as emergences; they are the reason specialist review is not optional in this method. The final material comprised **66 technology groups**.
...
*Doubling time* is ln 2 divided by the slope of log-share from the year of emergence to the peak year; it was not computed where the peak came less than two years after emergence or fewer than three years of growth were available (⟨n⟩ groups). *Peak share* is the maximum annual share. *Persistence* is the mean share in 2021–2022 divided by peak share; a group whose persistence fell below 0.5 was counted as a decline. Because 2023–2025 records are still being indexed, the same ratio on 2023–2025 is reported as a sensitivity analysis.
